    ...
    def main(self):
        for i in os.listdir(self.yt_labelme):
            if i.endswith('.json'):
                ...
                except_json = os.path.join("/home/lijq/data/A/test_a_coco/testdataset/0922/cm/320/exception",i)
                try:
...
if __name__ == '__main__':
    print('分析标注结果生成混淆矩阵')
    AnnalyResult('/home/lijq/data/A/test_a_coco/coco_test_confirm/dmjsons',#biaozhu jsons
                 '/home/lijq/data/A/380_r/preanno/dm/premerge',#pre jsons
                 '/home/lijq/data/A/380_r/preanno/dm/r380',#splite result file
                 'r380model_cfdmtestdata')# 混淆矩阵图像名字，不带后缀