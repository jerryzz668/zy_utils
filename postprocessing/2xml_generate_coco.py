...
if __name__ == "__main__":
    # annotation_root_path = r'D:\work\data\microsoft\jalama\sixth\cuts_modify\modataset'
    # out_coco_root_path = r'D:\work\data\microsoft\jalama\sixth\cuts_modify\cuts'
    ...
    #2coco
    labelme_json=glob.glob('D:/work/data/microsoft/jalama/saven/coco_0102/trainjsons/*.json')
    coco_path = os.path.join('D:/work/data/microsoft/jalama/saven/coco_0102','instances_train.json')
    labelme2coco(labelme_json,coco_path)


    cz_json= 'D:/work/data/microsoft/jalama/second_data_merge_3/coco/annotations/instances_val2017.json'
    save_json_path =os.path.join('D:/work/data/microsoft/jalama/saven/coco_0102','instances_train2017.json')
    Modify_COCO_Cate(cz_json,coco_path,save_json_path)
