...
if __name__ == '__main__':
    # AnnalyResult('D:/work/data/microsoft/jalama/ceshiji/all/jsons_dm',#biaozhu jsons
    #              'D:/work/data/microsoft/jalama/ceshiji/all/pre170',#pre jsons
    #              'D:/work/data/microsoft/jalama/ceshiji/all/out/170',#splite result file
    #              '170model_1203testdata')# 混淆矩阵图像名字，不带后缀
    # AnnalyResult('D:/work/data/microsoft/jalama/ceshiji/all/small/yt',#biaozhu jsons
    #              'D:/work/data/microsoft/jalama/ceshiji/all/small/pre',#pre jsons
    #              'D:/work/data/microsoft/jalama/ceshiji/all/small/out',#splite result file
    #              '170model_1203testdata')# 混淆矩阵图像名字，不带后缀
    l = [170,250,260,263]
    l = [1230]
    for i in l:
        AnnalyResult('D:/work/data/microsoft/jalama/sixth/third_cut/test/jsons',#biaozhu jsons
                     'D:/work/data/microsoft/jalama/sixth/third_cut/test/pre{}'.format(i),#pre jsons
                     'D:/work/data/microsoft/jalama/sixth/third_cut/test/{}'.format(i),#splite result file
                     '{}model_cut512_third_testdata'.format(i))# 混淆矩阵图像名字，不带后缀