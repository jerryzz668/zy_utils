...
def json_to_dataset_seg(Fs_Root_path,dir_json):
    ...
    out_image_path=train_seg_path+"\\image"
    if not osp.exists(out_image_path):
        os.mkdir(out_image_path)
    out_label_path=train_seg_path+"\\label"
...
Json_path='C:\\Users\\fs\\Desktop\\t'#Json文件夹路径
json_to_dataset_seg(Fs_Root_path,Json_path)
