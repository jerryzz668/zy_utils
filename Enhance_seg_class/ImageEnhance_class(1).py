...
def ImageEnhance_class(Fs_Root_path,sharpen=False,sp_noise=False,gasuss_noise=False,gamma=False,GaussianBlurring=False,equalizeHist=False,adaptivehistogram=False):
    imgDirPath=Fs_Root_path+"\\train_class"
...
ImageEnhance_class(Fs_Root_path,sharpen=False,sp_noise=True,gasuss_noise=False,
gamma=False,GaussianBlurring=False,equalizeHist=True,adaptivehistogram=True)
