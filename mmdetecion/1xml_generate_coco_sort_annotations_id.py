...
if __name__ == "__main__":
    annotation_root_path = r'C:\Users\xie5817026\Desktop\05'
    out_coco_root_path = r'C:\Users\xie5817026\Desktop\05'
    ...
    #2coco
    # start = time.time()
    # labelme_json=glob.glob(r'D:\work\data\A\D526-604\607\AD\cut\*.json')
    # coco_path = os.path.join(r'D:\work\data\A\D526-604\607\AD','adval.json')
    # labelme2coco(labelme_json,coco_path)
    # print('runtime:',time.time()-start)
    # #
    # cz_json= r'C:\Users\xie5817026\PycharmProjects\pythonProject1\0104\instances_val2017.json'
    # save_json_path =os.path.join(r'D:\work\data\A\D526-604\607\AD','instances_val2017.json')
    # Modify_COCO_Cate(cz_json,coco_path,save_json_path)
