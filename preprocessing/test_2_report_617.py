...
class AnnalyResult(object):
    def __init__(self, yt_labelme, test_labelme, out_path, title_png, align, dic_align,gt_cls):
    ...
    def compute_confmx(self, align, dic_align):
        ...
        print('self.gt_class---',self.gt_class)
...
def test_to_reports(sub_file, save_path, sheet, score_list, model_test_csv, align, dic_align):
    ...
    for i, score in enumerate(score_list):
        ...
        annalyresult = AnnalyResult(gt_json,
                                    ...
                                    align, dic_align,gt_cls)  # 混淆矩阵图像名字，不带后缀
...
if __name__ == '__main__':
    ...
    img_gt_path = r"D:\work\data\AD615\AA615"# 输入img和gt_json路径
    model_test_csv = r"D:\work\data\AD615\AAA\A616_r1"  # 输入csv路径
    score_list = [0.995]  # confidence设置，可随意设置几个
    align = False  # 是否进行标签对齐
    dic_align = {}  # 进行对齐的字典，key:pre_class,val:gt_class
    excel_save_path = r'D:\work\data\AD615\A_617_report.xlsx'
