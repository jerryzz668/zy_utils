...
if __name__ == "__main__":
    ...
    out_coco_root_path = '/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/NEWSTART/adcm/coco'
    # Select_data(annotation_root_path,out_coco_root_path)#过滤xml与img不符合情况

    img_jsons=os.path.join(annotation_root_path,'jsons')
    process_nums = 8
    result_write = os.path.join(out_coco_root_path,'R310_class_label.txt')
    ...
    # labelme2coco(labelme_json,coco_path)
    #
    # cz_json= '/home/lijq/PycharmProjects/micro-i-tools/code/a_dm_cz_gj_cm2000.json'
    # save_json_path =os.path.join('/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/jalama_ad/coco_ad_jalama/annotations','instances_val2017.json')
    # Modify_COCO_Cate(cz_json,coco_path,save_json_path)

    # Modify_COCO_Cate('/home/lijq/PycharmProjects/micro-i-tools/code/a_dm_cz_gj_cm2000.json',
    #                  '/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/jalama_ad/coco_ad_jalama/annotations/instances_val20171.json',
    #                  '/media/lijq/f373fb19-ec6a-4a1c-96e5-3f2013f3f5c6/jalama_ad/coco_ad_jalama/annotations/instances_val2017.json')
